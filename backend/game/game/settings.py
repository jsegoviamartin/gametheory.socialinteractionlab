...
SECURE_SSL_REDIRECT = env_bool('SECURE_SSL_REDIRECT', False)  # Nginx handles the redirect by default
...
LOGIN_URL = '/auth'
LOGIN_REDIRECT_URL = '/dashboard' # Redirect to user info or dashboard

TWO_FACTOR_PATCH_ADMIN = True
TWO_FACTOR_REMEMBER_COOKIE_AGE = 3600 * 24 * 30 # 30 days
TWO_FACTOR_REDIRECT_URL = '/dashboard'
