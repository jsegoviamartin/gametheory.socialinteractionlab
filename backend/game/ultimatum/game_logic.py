...
def update_game_stats(match_uuid, round_number):
    ...
    if round_number >= current_round.total_rounds:
        ...
        print(f"[update_game_stats] Ultimatum Game {match_uuid} completed at {current_round.match_completed_at}")
        print(f"[update_game_stats] Final scores: P1={p1_cumulative}, P2={p2_cumulative}")
